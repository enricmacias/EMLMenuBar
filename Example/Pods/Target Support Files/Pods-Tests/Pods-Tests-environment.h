...
// EMLMenuBar
#define COCOAPODS_POD_AVAILABLE_EMLMenuBar
#define COCOAPODS_VERSION_MAJOR_EMLMenuBar 1
#define COCOAPODS_VERSION_MINOR_EMLMenuBar 0
#define COCOAPODS_VERSION_PATCH_EMLMenuBar 0
